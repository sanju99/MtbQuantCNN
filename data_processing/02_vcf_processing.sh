...
# submit with sbatch data_processing/02_vcf_processing.sh /n/data1/hms/dbmi/farhat/Sanjana/MIC_data/single_drugs/MXF/paths.txt /n/scratch3/users/s/sak0914/annotated_VCF

# have a separate environment for samtools and bcftools
...
# find ~+ -type f  ! -name "*.eff.vcf" > /n/data1/hms/dbmi/farhat/Sanjana/MIC_data/vcf_files_for_annot.txt
