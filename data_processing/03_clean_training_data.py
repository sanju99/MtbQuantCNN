...
# example: python3 -u data_processing/03_clean_data.py MXF 0.5 /n/scratch3/users/s/sak0914/annotated_VCF
# example: python3 -u data_processing/03_clean_data.py RIF 0.5 /n/scratch3/users/s/sak0914/annotated_VCF
_, drug, cc, vcf_dir = sys.argv
cc = float(cc)
who_variants = pd.read_csv("/n/data1/hms/dbmi/farhat/Sanjana/MIC_data/WHO_resistance_variants_all.csv")

out_dir = f"/n/data1/hms/dbmi/farhat/Sanjana/MIC_data/single_drugs/{drug}"
model_df = f"{out_dir}/data_for_model.csv"
...
df_combined = df_phenos.merge(lineages[["ROLLINGDB_ID", "Lineage"]], on="ROLLINGDB_ID", how="left")
