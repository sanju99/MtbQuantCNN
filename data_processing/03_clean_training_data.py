...
# example: python3 -u data_processing/03_clean_training_data.py INH 0.2 /n/scratch3/users/s/sak0914/annotated_VCF
...
# for i, isolate in enumerate(df_combined["ROLLINGDB_ID"].values):
