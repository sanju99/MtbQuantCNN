...
isolate_variants_df = pd.read_csv(f"/n/data1/hms/dbmi/farhat/Sanjana/MIC_data/single_drugs/{drug}/isolate_variants.tsv", sep="\t")
output_file = f"/n/data1/hms/dbmi/farhat/Sanjana/MIC_data/single_drugs/{drug}/isolate_variants_fixed_annot.tsv"
...
pd.concat(df_new_lst, axis=0).to_csv(output_file, index=False, sep="\t")