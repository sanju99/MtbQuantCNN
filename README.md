...
All scripts in the <code>model</code> and <code>analysis/saliency</code> directories require the <code>tensorflow2_env</code> environment to run (because this environment includes tensorflow2). All other scripts and notebooks can be run using the <code>MtbQuantCNN_env.yaml</code> environment.
