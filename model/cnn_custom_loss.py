...
parser.add_argument('--train', dest='train_model', action='store_true', help='If true, train a new model. If false, just create input matrices and predictions if a model already exists.')
