...
# third dimension: CNN_inputs, can be of length 3-5. If length 3, there is nucleotide matrix, lower bounds, and upper bounds. If length 5, there is nuc matrix, AA matrix, lineage SNPs, lower bounds, and upper bounds
# so take the shape of the 3rd element
...
if include_lineage or include_peptide_lengths:
    additional_data_len = test_generator[0][0][2].shape[1]
else:
